...
<style>
    ...
    /* ── Sidebar: force dark text on light background ── */
    ...
    .header-card h1 { font-size: 1.6rem; margin: 0 0 6px 0; font-weight: 700; color: white !important; }
    .header-card p  { font-size: 0.95rem; margin: 0; opacity: 0.88; color: white !important; }
